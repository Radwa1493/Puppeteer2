    ...
    async isloginstatusDisplayed(){
       ...
       async Profile(){
        ...
        await page.click(elements.Profile_Buttom) ;
         // Get the text of the first  element on the page using page.$eval()
 const textContent = await page.$eval(elements.welcome_TXT, element => element.textContent);
 concole.log(textContent)
    }
}
