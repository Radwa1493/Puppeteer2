...
const elements ={
    loginEmail_TxtBox:  { return '#loginEmail' },
...
export default class ProfilePage extends BasePage {
    ...
    async isLoginPageDisplayed(){
        ...
        await page.waitForSelector(loginEmail_TxtBox)    
 
    }

    async EnterCredinial(){
    await page.click(".headerElement__icon--login") ;
       await page.$eval(loginEmail_TxtBox, input => input.value = ''); // Clear the text from the field
       await page.type(loginEmail_TxtBox,'ccjss@ccjss.com')
